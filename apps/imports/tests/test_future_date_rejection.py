...
class FutureDateRejectionTest(TestCase):
    def test_future_date_row_is_dropped(self):
        """Row with a future date (e.g. year 2027) is dropped into dropped_rows with a warning."""
        raw_data = [
            ["№", "ID", "Ответственный", "Сумма", "Дата Заказа", "статус", "Источник"],
            ["1001", "0191", "Amir Karimov", "100,000", "01.07.2027", "успешно", "Baza"],
        ]
