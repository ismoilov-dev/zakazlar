...
class SaleRepository:
    ...
    def bulk_upsert(self, sales: Iterable[Sale]) -> tuple[int, int]:
        ...
        Sale.objects.bulk_create(
            ...
            update_fields=["employee", "import_job", "status", "source", "sale_amount", "has_sheet_error", "profit_amount", "ordered_at", "client_name", "product_name", "quantity", "product_name_2", "quantity_2", "updated_at"],
